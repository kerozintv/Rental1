...
return [
    ...
    'attributes'           => [
        'name'     => 'név',
        'password' => 'jelszó',
        'cpassword' => 'jelszó megerősítés',
        'v_nev' => 'vezetéknév',
        'k_nev' => 'keresztnév',
        'phone' => 'telefonszám',
        'email_phone' => 'email cím vagy telefonszám',
        'adat_checkbox' => 'Adatkezelési nyilatkozat',
        'kolcsonzes_kezdete' => 'kölcsönzés kezdete',
        'kolcsonzes_vege' => 'kölcsönzés vége',
        'work_id' => 'alkalmazotti azonosító'
    ],
];
